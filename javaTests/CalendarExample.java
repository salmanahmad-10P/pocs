...
public class CalendarExample {
    ...
    private static void CalendarTimemethod() {
        ...
        System.out.println("Current date and time is: " + date+" : millis = "+date.getTime());
        System.out.println();
    }
    ...
    private static void SimpleDateFormatmethod() {
        ...
        System.out.println("Current date and time in simple date format: " + dateformatter.format(date.getTime()));
        System.out.println();
    }

    private static void Adddates() {

        System.out.println("Performing operations on calender dates.");
        ...
        System.out.println("Before two years it was: " + dateformatter.format(cldr.getTime()));
        ...
        cldr = (Calendar) date.clone();
        cldr.add(Calendar.DAY_OF_MONTH, + 28);
        System.out.println("After 28 days it will be: " + dateformatter.format(cldr.getTime()));
    ...
    private static void Getcalendermethods() {
        ...
        System.out.println("Various get methods of the calender class:");
        Calendar calender = Calendar.getInstance();

        System.out.println("Year                     : " + calender.get(Calendar.YEAR));
        System.out.println("Month                    : " + calender.get(Calendar.MONTH));
        System.out.println("Day of Month             : " + calender.get(Calendar.DAY_OF_MONTH));
        ...
        System.out.println("Week of Year             : " + calender.get(Calendar.WEEK_OF_YEAR));
